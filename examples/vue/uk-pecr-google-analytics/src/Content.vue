<template>
  <main style="font-family: system-ui; max-width: 640px; margin: 4rem auto; padding: 0 1rem">
    <h1>Tickbox Vue — UK PECR + Google Analytics</h1>
    <p>
...
<style scoped>
.banner { position: fixed; inset-inline: 1rem; bottom: 1rem; max-width: 32rem; margin: 0 auto; background: white; border-radius: 0.5rem; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.15); padding: 1rem 1.25rem; }
