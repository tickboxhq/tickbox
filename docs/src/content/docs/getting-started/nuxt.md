...
For the drop-in styled banner, see [Default styled banner](/getting-started/banner-default/). The default banner ships with built-in translations for nine European languages (including Ukrainian) and integrates cleanly with `vue-i18n` — see the [i18n recipe](/recipes/i18n/).
